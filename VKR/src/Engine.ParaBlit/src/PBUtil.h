...
namespace PB
{
	...
	PARABLIT_API inline VkShaderStageFlagBits ConvertPBRayTracingShaderStageToVK(ERayTracingShaderStage stage);
	...
	PARABLIT_API inline void GetMemoryBarrierOfType(EMemoryBarrierType type, VkMemoryBarrier& outBarrier, VkPipelineStageFlags& srcStage, VkPipelineStageFlags& dstStage);

	PARABLIT_API inline void GetBufferMemoryBarrierOfType(EMemoryBarrierType type, VkBuffer bufferHandle, u32 offset, u32 size, VkBufferMemoryBarrier& outBarrier);
}