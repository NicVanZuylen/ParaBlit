...
private:
	...
	struct BakedNode
	{
		const BakedNode& GetChild(uint32_t childIndex) const { return *(this + (childIndex + 1)); }
	...
	void BuildDrawBatches(BuildNode* root, CLib::Vector<PB::Pipeline>& excludedPipelines);
