...
void Camera::Update()
{
	...
	else
	{
		...
		m_frustrum.m_nearTopLeft = nearCentre + (Up() * halfHeight) - (Right() * halfWidth);
		m_frustrum.m_nearTopRight = nearCentre + (Up() * halfHeight) + (Right() * halfWidth);
		m_frustrum.m_nearBottomLeft = nearCentre - (Up() * halfHeight) - (Right() * halfWidth);
		m_frustrum.m_nearBottomRight = nearCentre - (Up() * halfHeight) + (Right() * halfWidth);

		m_frustrum.m_farTopLeft = farCentre + (Up() * halfHeight) - (Right() * halfWidth);
		m_frustrum.m_farTopRight = farCentre + (Up() * halfHeight) + (Right() * halfWidth);
		m_frustrum.m_farBottomLeft = farCentre - (Up() * halfHeight) - (Right() * halfWidth);
		m_frustrum.m_farBottomRight = farCentre - (Up() * halfHeight) + (Right() * halfWidth);
	}
	...
	if (m_projectionType == EProjectionType::PERSPECTIVE)
	{
		...
		m_frustrum.m_near = { -Forward(), projectedNear };
